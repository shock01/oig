describe('dicontext', function () {
  ...
  beforeEach(function () {
    diContext = new OigDIContext();
    sandbox = sinon.sandbox.create();
    typeParser = oigLocator.resolve('oigTypeParser');
  });
  ...
  describe('resolve', function () {
    ...
    describe('with dependencies', function () {
      ...
      it('should throw exception on missing dependency', function () {
        typeInfo.constructorType.arguments = [{name: 'missing'}];
        expect(function () {
      ...
      it('should resolve the dependency', function () {
        typeInfo.constructorType.arguments = [{name: 'dependency'}];
        instance = diContext.resolve('test');
