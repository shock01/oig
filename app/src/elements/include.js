 ...
 * Examples:
 *  Parse: (xml|text\html)
 *  <oig-include href="partials/include/star.svg" parse="xml"></oig-include>
 *
 *  XPointer:
 *  <oig-include xpointer="//h1"></oig-include>
 *
 *  Fallback:
 *  <oig-include href="partials/include/404">
 *    <template>
 *       <div class="alert alert-danger">I am displayed as fallback element</div>
  *   </template>
  *</oig-include>
...
(function() {
  /**
  * @todo enable proper cors loading
  */
  ...
  var IncludeElement = document.registerElement('oig-include', {
    prototype: Object.create(HTMLDivElement.prototype, {
      resourceLoader: {
        value: new IncludeResource()
      },
      /**
       */
      attachedCallback: {
  ...
  oig.IncludeElement = IncludeElement;
}(oig || (oig = {})))
